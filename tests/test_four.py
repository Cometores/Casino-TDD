...
class TestThree(unittest.TestCase):
    def test_player_can_play_two_dice_game(self):
        ...
        player_Alex.bet_two_dice(100, 12)
        player_Alex.bet_two_dice(500, 2)
    ...
    def test_player_can_bet_on_numbers_from_2_to_12(self):
        ...
        for i in range(2, 13):
            player_Alex.bet_two_dice(100, i)

        with self.assertRaises(Exception):
            player_Alex.bet_two_dice(100, 1)

        with self.assertRaises(Exception):
            player_Alex.bet_two_dice(100, 13)
